...
4. Розв'язати задачу згідно з варіантом. Намалювати блок-схему.
	1. Описати клас з ім'ям Student, що містить такі поля:
    - прізвище;
    - номер групи;
    ...
    2. Описати клас з ім'ям Aeroflot, що містить такі поля:
    ...
    3. Описати клас з ім'ям Train, що містить такі поля:
    ...
    4. Описати клас з ім'ям Marsh, що містить такі поля:
    ...
    5. Описати клас з ім'ям Note, що містить такі поля:
    - прізвище;
    - номер телефону;
    ...
    6. Описати клас з ім'ям Znak, що містить такі поля:
    - прізвище;
    - знак зодіаку;
    - день народження (масив із 3 чисел).
    Написати програму, яка виконує такі дії:
    ...
    7. Описати клас з іменем Price, що містить такі поля:
    - Назва товару;
    ...
    8. Описати клас з ім'ям Order, що містить такі поля:
    ...
    9. Описати клас з ім'ям Student, що містить такі поля:
    - прізвище;
    - номер групи;
    - успішність (масив із 5 елементів).
    Написати програму, яка виконує такі дії:
    ...
    10. Описати клас з ім'ям Aeroflot, що містить такі поля:
    - назву пункту призначення;
    - номер рейсу;
    - тип літака.
    Написати програму, яка виконує такі дії:
