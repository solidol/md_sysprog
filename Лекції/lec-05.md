...
Цей приклад розв’язується з використанням вкладених циклів. Процес порівняння елементів відбувається немов у &#8220;три руки&#8221;. Одна рука за параметром **і** вибирає елемент з масиву **аі**, друга за параметром **j** вибирає елемент з масиву **bj**, а третя за параметром **k **розташовує вибраний елемент у масив с**k**.
